  ...
  return (
    <div>
      ...
      <div className="content">
        ...
        <p className="text"> What I love about coding is being able to create something tangible out of an idea, and along the way being constantly challenged to creatively to find a solution. I am an increadibely hard worker, who loves colloborating and learning new things. </p>
